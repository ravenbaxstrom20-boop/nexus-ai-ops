...
router.post('/', async (req, res) => {
    const { firstName, lastName, email, phone, company, status, source, value, score } = req.body;
    ...
    try {
        ...
        // This is asynchronous and won't block the response
        WorkflowExecutionService.triggerLeadWorkflows(newLead).catch(err => {
